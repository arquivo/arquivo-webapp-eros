...
<section id="institutional">
  <h4>Institutional</h4>
    ...
    <a href="//www.fccn.pt/" target="_blank" title="Visit the website of FCCN - Funda&ccedil;&atilde;o para a computa&ccedil;&atilde;o Cient&iacute;fica Nacional"> <img src="assets/img/logo-fccn.png" alt="FCCN - Funda&ccedil;&atilde;o para a computa&ccedil;&atilde;o Cient&iacute;fica Nacional"></a> 
    <!-- ends FCT image logo link --> 
       <!-- starts República Portuguesa image logo link --> 
    <a href="//www.portugal.gov.pt/pt/ministerios/mctes.aspx" target="_blank" title="Visit the website of the Portuguese government"> <img src="assets/img/gov-pt.png" alt="Portuguese government"></a> 
    <!-- ends República Portuguesa image logo link --> 
    <!-- starts copyright  -->
    <p>&copy;<?php echo date("Y");?> – FCT | FCCN, all rights reserved.
    <!-- ends copyright  -->
  </section>
