...
COPY --chown=node:node --chmod=444 bin ./bin
RUN chmod 555 /home/node/app/bin
...
# Copy vendor files generated by postinstall in production-deps
COPY --from=production-deps --chown=node:node --chmod=444 /home/node/app/public/vendor ./public/vendor
...
RUN find /home/node/app/node_modules -type f -exec chmod 444 {} \; && \
    ...
    find /home/node/app/public/vendor -type f -exec chmod 444 {} \; && \
    find /home/node/app/public/vendor -type d -exec chmod 555 {} \;
