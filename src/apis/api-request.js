...
class ApiRequest {
    constructor(apiUrl, defaultApiParams = {}, defaultApiReply = {}) {
        ...
        this.endFunction = (requestData) => { return () => { try { this.apiData = JSON.parse(this.apiReply) } catch (e) { this.logger.error(this.apiUrl + ' : ' + e); this.apiData = this.defaultApiReply }; } };
        ...
        try {
            ...
            (apiRes) => {
                if(apiRes.statusCode < 200 || apiRes.statusCode >= 300) {
                    this.errorFunction(requestData,callback)(new Error('Invalid status code: ' + apiRes.statusCode));
                } else {
